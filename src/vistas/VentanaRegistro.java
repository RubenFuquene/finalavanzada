...
public class VentanaRegistro extends javax.swing.JFrame {
     ...
     */
    public VentanaRegistro(ControladorRegistro control)
    {
        this.controladorRegistro = control;
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                ...
                || !(esCampoValido(String.valueOf(txtPass.getPassword()))))
    	{
            ...
            if(controladorRegistro.registrarEmpleado(txtNombre.getText(), txtApellido.getText(), 
                txtNick.getText(), String.valueOf(txtPass.getPassword())))
            {
                JOptionPane.showMessageDialog(null, "Empleado creado exitosamente");
                this.controladorRegistro.lanzarVentanaInicial();
                this.dispose();
            }else
            {
